...
$Workspace = "codex_manual_ws"
$AuditId = "audit_codex_manual"
$Title = "Manual Codex test"
$Policy = "low_noise"
$TimeoutSeconds = 300
...
python cli.py run-all-tasks --workspace $Workspace --backend codex --timeout-seconds $TimeoutSeconds --max-iterations 50
if ($LASTEXITCODE -ne 0) { throw "run-all-tasks failed" }
